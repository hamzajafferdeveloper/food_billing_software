...
const EditRoomModal = ({ onOpen, onOpenChange, prevData }: Props) => {
    const [data, setData] = useState({
        number: prevData?.number || '',
        type: prevData?.type || '',
        price_per_night: prevData?.price_per_night || '',
        note: prevData?.note || '',
    });
    ...
    const handleFormSubmit = (e: React.FormEvent) => {
        ...
        router.put(room.update.url(prevData?.id), data);
            ...
            <DialogContent>
                <form onSubmit={handleFormSubmit} className="space-y-6">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Update the field and click <b>‘Save changes’</b> to update a new room.
                        </DialogDescription>
                    </DialogHeader>
